...
public class IDCardUtil {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(IDCardUtil.isIDCard("110000198601019914"));
    	String key ="7878787878080989708778787878780809897087";
    	String start_node_number = "232434351314525253";
    	String end_node_number = "79798798ihofiaoihnva";
